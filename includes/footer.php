...
<li><a href="./admin/"><i class="icon fa fa-sign-in"></i>&nbsp Admin/R&D Team Login</a></li> 
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Maintain by <a href="./">BR World portal </a></p>
		...
		<div class="table-responsive">
			<table class="table">
				<tbody>
					...
					<tr><td>Saturday:</td><td class="pull-right">11:00AM To 07:00PM</td></tr>
					<tr><td>Sunday:</td><td class="pull-right">12:00PM To 07:00PM</td></tr>
				</tbody>
			</table>
		</div>
	</div>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="https://brworld.com/">brworld.com</a></span>
                </div>
            </li>
