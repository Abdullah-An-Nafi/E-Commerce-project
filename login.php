...
<html lang="en">
	<head>
	    ...
	    <title>BR World Portal | Signi-in | Signup</title>
...
<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" maxlength="12" required >
	  	</div>
<div class="form-group">
